...
export function Builder() {
	...
	return (
		<>
			<a href="/emergency-sos" className="md:inline-block hidden">
				<button className="bg-white dark:bg-stone-950 no-underline group cursor-pointer relative p-px text-xs font-semibold leading-6 text-black dark:text-white border-2 border-black dark:border-none shadow-[1px_1px_rgba(0,0,0),2px_2px_rgba(0,0,0),3px_3px_rgba(0,0,0)] dark:shadow-none transition-all">
					<div className="relative flex space-x-2 items-center z-10 rounded-none bg-white dark:bg-zinc-950 py-2 px-4">
						<PlusIcon size={14} />
						<span className="uppercase tracking-wide text-[10px]">Emergency SOS</span>
					</div>
				</button>
			</a>
			<Dialog>
